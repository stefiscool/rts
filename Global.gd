...
var unitDict = {
	...
	"Imperial Sapper": {
		...
		"skills": ["Fireball"],
		"conditions": ["Burn"],
		"desc": "A demolitions expert who uses explosive charges to breach enemy fortifications. His grenades can devastate clustered enemies but have limited range."
	},
	"Imperial Hussar": {
		"cost": 28,
		"maxHp": 110,
